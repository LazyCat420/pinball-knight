//! The knight: movement, sprint, wall work, dodge roll and attack timing constants.
//!
//! Port of `legacy/src/game/pinball-knight/constants/player.ts` (295 lines).
//!
...
pub const MAX_ATLAS_WIDTH: usize = 8192;
