...
const ZOMBIE_E_PNG: &[u8] = include_bytes!("../../../assets/sprites/zombie-E.png");
const ZOMBIE_E_JSON: &str = include_str!("../../../assets/sprites/zombie-E.json");
const BRUTE_S_PNG: &[u8] = include_bytes!("../../../assets/sprites/brute-S.png");
const BRUTE_S_JSON: &str = include_str!("../../../assets/sprites/brute-S.json");
const FROG_S_PNG: &[u8] = include_bytes!("../../../assets/sprites/frog-S.png");
const FROG_S_JSON: &str = include_str!("../../../assets/sprites/frog-S.json");
const GOBLIN_S_PNG: &[u8] = include_bytes!("../../../assets/sprites/goblin-S.png");
const GOBLIN_S_JSON: &str = include_str!("../../../assets/sprites/goblin-S.json");
const JESTER_S_PNG: &[u8] = include_bytes!("../../../assets/sprites/jester-S.png");
const JESTER_S_JSON: &str = include_str!("../../../assets/sprites/jester-S.json");
const REAPER_S_PNG: &[u8] = include_bytes!("../../../assets/sprites/reaper-S.png");
const REAPER_S_JSON: &str = include_str!("../../../assets/sprites/reaper-S.json");
const SLIME_S_PNG: &[u8] = include_bytes!("../../../assets/sprites/slime-S.png");
const SLIME_S_JSON: &str = include_str!("../../../assets/sprites/slime-S.json");
const SPIDER_S_PNG: &[u8] = include_bytes!("../../../assets/sprites/spider-S.png");
const SPIDER_S_JSON: &str = include_str!("../../../assets/sprites/spider-S.json");
const STILTNECK_S_PNG: &[u8] = include_bytes!("../../../assets/sprites/stiltneck-S.png");
const STILTNECK_S_JSON: &str = include_str!("../../../assets/sprites/stiltneck-S.json");
const SHEET_S_PNG: &[u8] = include_bytes!("../../../assets/sprites/pinball_knight-S.png");
const SHEET_S_JSON: &str = include_str!("../../../assets/sprites/pinball_knight-S.json");
const SHEET_E_PNG: &[u8] = include_bytes!("../../../assets/sprites/pinball_knight-E.png");
const SHEET_E_JSON: &str = include_str!("../../../assets/sprites/pinball_knight-E.json");
const SHEET_N_PNG: &[u8] = include_bytes!("../../../assets/sprites/pinball_knight-N.png");
const SHEET_N_JSON: &str = include_str!("../../../assets/sprites/pinball_knight-N.json");
