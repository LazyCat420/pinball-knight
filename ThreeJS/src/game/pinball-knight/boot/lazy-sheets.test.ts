...
const ALL_KEYS: SheetKey[] = [
  ...
  "shark_trapper", "dolphin_brawler", "octopus_gunner", "clownfish_mob", "lionfish_mob", "anglerfish_mob", "pufferfish_mob", "swordfish_mob", "moray_mob", "seahorse_mob", "pinball_boss", "christmas_tree", "gas_can", "hamster_ball",
];
