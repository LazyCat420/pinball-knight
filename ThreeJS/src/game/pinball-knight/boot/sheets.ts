...
export type SheetKey =
  ...
  | "reaper" | "broodmother" | "overlord" | "archivist" | "dragon" | "trex" | "jade_buddha" | "burger" | "fries" | "milkshake" | "crawling_hand" | "sumo_ninja" | "six_armed_god" | "zippo" | "cerberus" | "clam" | "crab" | "pinball_boss" | "medusa" | "dracula"
...
export const SHEET_KEYS = new Set<string>([
  ...
  "goblin", "pin", "golem", "chomper", "magnet", "webspinner", "sporeling",
  "hound", "jester", "croaker", "rotortail", "stiltneck", "fish_feet",
  "necromancer", "crystalback", "mimic", "bloater", "platypus", "espresso", "gnome", "cigarette", "toucan", "reaper", "broodmother", "overlord", "archivist", "dragon", "trex", "jade_buddha", "burger", "fries", "milkshake", "crawling_hand", "sumo_ninja", "six_armed_god", "zippo", "cerberus", "clam", "crab", "pinball_boss", "medusa", "dracula",
  "dragon_snake_head", "dragon_snake_body", "dragon_snake_tail",
]);
...
export function keysForFloor(level: number): SheetKey[] {
  ...
  if (level >= 5) keys.push("reaper", "archivist", "broodmother", "dragon", "trex", "jade_buddha", "six_armed_god", "cerberus", "pinball_boss", "medusa", "dracula", "dragon_snake_head", "dragon_snake_body", "dragon_snake_tail");
  return [...new Set(keys)];
}
