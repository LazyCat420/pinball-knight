...
describe("Boss Roster and Modular Boss Art Verification", () => {
  ...
  it("registers all bosses in BOSSES table with valid specs", () => {
    const expectedBosses: BossKind[] = ["reaper_king", "broodmother", "overlord", "archivist", "dragon", "trex", "jade_buddha", "six_armed_god", "cerberus", "pinball_boss", "doppelganger"];
  ...
  it("wires every boss sheetKey to IMPORTED_ART and SHEET_PAINTERS", () => {
    const bossSheetKeys: SheetKey[] = ["reaper", "broodmother", "overlord", "archivist", "dragon", "trex", "jade_buddha", "six_armed_god", "cerberus", "pinball_boss", "doppelganger"];
