...
beforeEach(() => {
  ...
  const renderer = { domElement: { clientWidth: 1200, clientHeight: 800 }, getPixelRatio: () => 1, setPixelRatio: vi.fn(), init: vi.fn(async () => {}), compileAsync: vi.fn(async () => {}), setRenderTarget: vi.fn(), render: vi.fn() };
