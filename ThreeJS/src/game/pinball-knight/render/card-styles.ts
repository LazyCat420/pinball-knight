...
export const KIND_STYLE: Record<EnemyKind, StyleId> = {
  ...
  croaker: "chitin",
  // Scaled and wet, so it prints on the same stock as the amphibian.
  fish_feet: "chitin",
  rotortail: "iron",
  ...
  dracula_bat: "ink",
  spinning_top: "iron",
  shark_trapper: "chitin",
  dolphin_brawler: "bone",
  octopus_gunner: "chitin",
  clownfish_mob: "chitin",
  lionfish_mob: "chitin",
  anglerfish_mob: "chitin",
  pufferfish_mob: "chitin",
  swordfish_mob: "chitin",
  moray_mob: "chitin",
  seahorse_mob: "chitin",
  pinball_boss: "iron",
  christmas_tree: "bone",
