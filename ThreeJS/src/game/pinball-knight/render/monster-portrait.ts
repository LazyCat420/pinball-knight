...
export const KIND_PORTRAIT: Record<EnemyKind, { paints: () => ActorPaints }> = {
  ...
  toucan: { paints: makeToucanPaints },
  jade_buddha: { paints: makeBossPaints },
  burger: { paints: makeBurgerPaints },
  fries: { paints: makeFriesPaints },
  milkshake: { paints: makeMilkshakePaints },
  crawling_hand: { paints: makeCrawlingHandPaints },
  sumo_ninja: { paints: makeSumoNinjaPaints },
  zippo: { paints: makeZippoPaints },
  ...
  corvid_bomber: { paints: makeCorvidBomberPaints },
  ...
  hotdog: { paints: makeHotdogPaints },
  ketchup: { paints: makeKetchupPaints },
  mustard: { paints: makeMustardPaints },
  don_quixote: { paints: makeDonQuixotePaints },
};
