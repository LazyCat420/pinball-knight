...
function sixArmedGodFrame(dir: Dir, phase: number, opts: PoseOpts = {}): FramePaint {
  return (ctx) => {
    ...
    if (dead) {
      ...
      // Fragmented stone torso shards
      plateShaded(ctx, [[CX - 14, GROUND - 4], [CX - 6, GROUND - 14], [CX + 2, GROUND - 8], [CX - 6, GROUND - 2]], R_BRONZE_DK);
      plateShaded(ctx, [[CX + 4, GROUND - 3], [CX + 12, GROUND - 16], [CX + 18, GROUND - 6]], R_BRONZE);
    ...
    if (armsRaised) {
      ...
      plateShaded(ctx, [[CX - 9, baseY - 4], [CX - 18, baseY - 16], [CX - 14, baseY - 18], [CX - 7, baseY - 6]], R_BRONZE);
      plateShaded(ctx, [[CX + 7, baseY - 6], [CX + 14, baseY - 18], [CX + 18, baseY - 16], [CX + 9, baseY - 4]], R_BRONZE);
      // Middle arms flared outward
      plateShaded(ctx, [[CX - 9, baseY], [CX - 22, baseY - 4], [CX - 20, baseY - 8], [CX - 8, baseY - 2]], R_BRONZE);
      plateShaded(ctx, [[CX + 8, baseY - 2], [CX + 20, baseY - 8], [CX + 22, baseY - 4], [CX + 9, baseY]], R_BRONZE);
      // Lower arms forward-pointing
      plateShaded(ctx, [[CX - 8, baseY + 4], [CX - 18, baseY + 6], [CX - 16, baseY + 2], [CX - 7, baseY + 2]], R_BRONZE);
      plateShaded(ctx, [[CX + 7, baseY + 2], [CX + 16, baseY + 2], [CX + 18, baseY + 6], [CX + 8, baseY + 4]], R_BRONZE);
      ...
      plateShaded(ctx, [[CX - 9, baseY - 4], [CX - 16, baseY - 12 + armWobble], [CX - 13, baseY - 14 + armWobble], [CX - 7, baseY - 6]], R_BRONZE);
      plateShaded(ctx, [[CX + 7, baseY - 6], [CX + 13, baseY - 14 - armWobble], [CX + 16, baseY - 12 - armWobble], [CX + 9, baseY - 4]], R_BRONZE);

      plateShaded(ctx, [[CX - 9, baseY], [CX - 18, baseY - 2 + armWobble], [CX - 16, baseY - 5 + armWobble], [CX - 8, baseY - 2]], R_BRONZE);
      plateShaded(ctx, [[CX + 8, baseY - 2], [CX + 16, baseY - 5 - armWobble], [CX + 18, baseY - 2 - armWobble], [CX + 9, baseY]], R_BRONZE);

      plateShaded(ctx, [[CX - 8, baseY + 4], [CX - 15, baseY + 8 + armWobble], [CX - 13, baseY + 5 + armWobble], [CX - 7, baseY + 2]], R_BRONZE);
      plateShaded(ctx, [[CX + 7, baseY + 2], [CX + 13, baseY + 5 - armWobble], [CX + 15, baseY + 8 - armWobble], [CX + 8, baseY + 4]], R_BRONZE);
...
export function makeSixArmedGodPaints(): ActorPaints {
  return {
    S: {
      ...
      death: [
        sixArmedGodFrame("S", 0.0, { dead: true, crumble: 0.2 }),
        sixArmedGodFrame("S", 0.33, { dead: true, crumble: 0.5 }),
        sixArmedGodFrame("S", 0.66, { dead: true, crumble: 0.8 }),
        sixArmedGodFrame("S", 1.0, { dead: true, crumble: 1.0 }),
      ],
    },
    N: {
      ...
      death: [sixArmedGodFrame("N", 1.0, { dead: true })],
    },
    E: {
      ...
      death: [sixArmedGodFrame("E", 1.0, { dead: true })],
    },
  };
}
