 ...
 */
export type MarbleMaterial = "diamond" | "water" | "stone" | "storm" | "shadow" | "lava" | "magnet";
...
export interface Player extends Actor {
  ...
  /** Crawling Hand grab & hold: while > 0 player is pinned in place while horde attacks. */
  handGrabT?: number;
...
export type FloorFxKind = "slick" | "fire" | "shard-field" | "oil" | "groove" | "frost" | "tar" | "rod" | "molten" | "fissure" | "coffee" | "rot" | "ink" | "shock" | "mustard" | "ketchup";
