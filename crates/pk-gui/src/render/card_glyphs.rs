...
pub fn glyph_sword() -> Vec<(f64, f64)> {
    poly_points(&[
        0.0, -0.95, 0.15, -0.7, 0.1, 0.3, 0.35, 0.35, 0.35, 0.45, 0.08, 0.45, 0.08, 0.85, -0.08,
        0.85, -0.08, 0.45, -0.35, 0.45, -0.35, 0.35, -0.1, 0.3, -0.15, -0.7,
    ])
}

pub fn glyph_shield() -> Vec<(f64, f64)> {
    poly_points(&[
        -0.75, -0.85, 0.75, -0.85, 0.75, -0.2, 0.5, 0.4, 0.0, 0.9, -0.5, 0.4, -0.75, -0.2,
    ])
}

pub fn glyph_fire() -> Vec<(f64, f64)> {
    poly_points(&[
        0.0, -0.9, 0.35, -0.4, 0.2, -0.1, 0.65, 0.2, 0.45, 0.75, 0.0, 0.9, -0.45, 0.75, -0.65, 0.2,
        -0.2, -0.1, -0.35, -0.4,
    ])
}
...
pub fn glyph_lightning() -> Vec<(f64, f64)> {
    poly_points(&[
        0.1, -0.95, -0.5, -0.05, -0.05, -0.05, -0.2, 0.95, 0.5, 0.05, 0.05, 0.05,
    ])
}

pub fn glyph_heart() -> Vec<(f64, f64)> {
    poly_points(&[
        0.0, -0.4, 0.3, -0.85, 0.75, -0.7, 0.85, -0.2, 0.5, 0.35, 0.0, 0.9, -0.5, 0.35, -0.85,
        -0.2, -0.75, -0.7, -0.3, -0.85,
    ])
}

pub fn glyph_skull() -> Vec<(f64, f64)> {
    poly_points(&[
        -0.7, -0.3, -0.6, -0.75, 0.0, -0.9, 0.6, -0.75, 0.7, -0.3, 0.5, 0.3, 0.35, 0.75, -0.35,
        0.75, -0.5, 0.3,
    ])
}
