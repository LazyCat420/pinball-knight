...
use pk_gui::render::arc_kickers::{build_kicker_geometry, ArcKickerVisual, KickBand, ARC_KICK_FLASH};

#[test]
fn arc_kickers_generates_band_and_cap_geometry() {
    let kicker_geo = build_kicker_geometry(0.0, 0.0, 3.0, 0.0, std::f64::consts::PI / 2.0, 0.1, 0.9, 0.08);
