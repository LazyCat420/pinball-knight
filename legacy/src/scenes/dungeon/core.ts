 ...
 */
/** Test seam for the one pickup path still core-owned; coins.test.ts imports
 *  everything else straight from economy/coins.ts. Retires in step 3. */
export const __coinInternals = { checkPickups };
